                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="details.php?id=<?= $utilisateur['id'] ?>" class="btn btn-success mx-1">Voir</a>
                                                    <a href="edit.php?id=<?= $utilisateur['id'] ?>" class="btn btn-warning mx-1">Modifier</a>
                                                    <a href="delete.php?id=<?= $utilisateur['id'] ?>" class="btn btn-danger mx-1">Supprimer</a>
                                                </td>
                                            </tr>
                                        <?php
                                            }
