...
if($_POST) 
{
    ...
    ) 
    {
        ...
        $sql = 'INSERT INTO utilisateur (nom, prenom, email, tel, type_utilisateur) VALUES(:nom, :prenom, :email, :tel, :type_utilisateur);';
        ...
        $_SESSION['message'] = "Profil de l'utilisateur ajouté";
                    ...
                    <main class="container">
                        <div class="row">
                            <section class="col-12">
                                ...
                                ?>
                                <h1>Ajouter le profil d'un utilisateur</h1>
                                <form method="post">
